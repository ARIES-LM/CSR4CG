...
datapath=/apdcephfs/share_47076/yongjingyin/cogmt/data/cg-test/
evalpath=/apdcephfs/share_47076/yongjingyin/cogmt/eval
...
CUDA_VISIBLE_DEVICES=${2} python3 -u $RUN/fairseq/fairseq_cli/generate.py $datapath/bin \
    --path $ckp \
    --batch-size 512 --beam 5 --remove-bpe >$GEN
