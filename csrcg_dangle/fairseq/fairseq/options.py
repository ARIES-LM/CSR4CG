...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if train:
        ...
        # added
        group.add_argument('--validate-after-epoch', type=int, default=0, metavar='N',)
...
def add_generation_args(parser):
    ...
    group.add_argument('--source-bpe-decode', action='store_true')
    group.add_argument('--target-bpe-decode', action='store_true')
