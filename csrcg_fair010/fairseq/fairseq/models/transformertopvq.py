...
@register_model("transformer_vqtop")
...
class TransformerEncoder(FairseqEncoder):
    ...
    def kmquantize(self, x, special, src_tokens, bibranch=False):
        ...
        # * Z
        if not self.args.vq_pretrain:
            # close EMA
            self.input_quantizer.eval()
...
@register_model_architecture("transformer_vqtop", "transformer_vqtop")
...
@register_model_architecture("transformer_vqtop", "transformer_vqtop_iwslt_de_en")
