...
@register_model("transformer_vqlm")
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def __init__(self, args, encoder, decoder):
        ...
        self.layernorm_vq = LayerNorm(args.vq_dim, export=export)
    ...
    def add_args(parser):
        ...
        parser.add_argument('--vq-ema', type=float, default=0.999)
    ...
    def forward(
        ...
        # TB G
        # codes = q["idx"].view(tsize, bsize, -1).transpose(0, 1)
        # for il in range(bsize):
        #     print([self.encoder.dictionary[w] for w in src_tokens[il]])
        #     print(codes[il])
        #     if il == 20:
        #         break
        # exit()
...
@register_model_architecture("transformer_vqlm", "transformer_vqlm")
...
@register_model_architecture("transformer_vqlm", "transformer_vqlm_iwslt_de_en")
